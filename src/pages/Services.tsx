...
> = {
  bending: {
    ...
    description:
      "Bending across multiple axes to meet specified angles and tolerances.",
    image: "/axis.png",
  },
  bead: {
    title: "Bead Forming",
  ...
  cutting: {
    ...
    description:
      "Cutting raw material to required lengths based on drawing specifications.",
    image: "/precision.png",
  },
  stamping: {
    title: "Stamping",
  ...
  welding: {
    ...
    description:
      "Joining metals using brazing and welding based on application requirements.",
    image: "/brazing.png",
  },
  assembly: {
    title: "Assembly",
    description:
      "Assembling multiple parts into a finished unit as per design requirements.",
    image: "/assembly.png",
  },
  surface: {
    title: "Surface Treatment",
    description:
      "Surface finishing processes carried out based on material and application needs.",
    image: "/surface.png",
  },
};
...
transition"
          ...
          {/* Tabs */}{" "}
          <div ref={tabRef} className="overflow-hidden relative">
            {" "}
            <div className="flex gap-4 md:gap-6 w-max md:w-full justify-start">
              {" "}
              {services.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "h-12 md:h-14 px-4 md:px-6 text-sm md:text-base font-medium whitespace-nowrap border-b-2 transition",
                      isActive
